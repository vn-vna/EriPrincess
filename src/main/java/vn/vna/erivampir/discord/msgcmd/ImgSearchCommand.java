        ...
        event
                ...
                .queue((message -> {
                    ...
                    if (nreq > 1) {
                        message
                                .editMessage(
                                        "There are multiple embed found, eri will only find result for the first one")
                                .mentionRepliedUser(false)
                                .queue();
                    }
                    ...
                    new Thread(() -> {
                        ...
                        if (statusOk && resultCount > 0) {
                            ...
                            if (!Objects.isNull(bestMatch.getData().getExtUrls())
                                    && !bestMatch.getData().getExtUrls().isEmpty()) {
                            ...
                            String imgTitle = Objects.isNull(bestMatch.getHeader().getIndexName()) ? "NO TITLE"
                                    : bestMatch.getHeader().getIndexName();
